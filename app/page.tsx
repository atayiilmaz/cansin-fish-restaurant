...
export const metadata: Metadata = { alternates: { canonical: "/", languages: { "tr-TR": "/", "en-US": "/en" } } };
  ...
  return (
    <main>
      ...
      <section className="story" data-reveal>
        ...
        <div className="story-copy" data-reveal-item><h2>Köprüden geçenlerin değil,<br /><span className="accent">köprüde kalanların</span> sofrası.</h2><p>Vapur sesleri, martılar, İstanbul’un iki yakası… Cansın’da yemek yalnızca yemek değildir. Şehrin tam kalbinde, denize birkaç adım mesafede paylaşılan bir İstanbul hatırasıdır.</p><Link className="text-link" href="/hakkimizda">Hikâyemizi okuyun <ArrowIcon /></Link></div>
      ...
      <section className="view-break parallax-frame" data-reveal>
        ...
        <div className="view-copy" data-reveal-item><h2>Manzaraya karşı<br />bir lokma daha.</h2><p>Ayaklarınızın altında deniz, karşınızda şehrin asırlık silüeti.</p></div>
      </section>

      <section className="flavours" data-reveal>
        <div className="section-heading" data-reveal-item><h2>Deniz ne verdiyse,<br /><span className="accent">usta onu güzelleştirir.</span></h2><Link className="text-link" href="/lezzetler">Tüm lezzetler <ArrowIcon /></Link></div>
