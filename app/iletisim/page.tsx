  ...
  return (
    <main className="contact-page">
      ...
      <section className="map-section" aria-labelledby="map-title">
        <div className="map-heading"><p className="eyebrow dark">Galata Köprüsü · Eminönü</p><h2 id="map-title">Haritada Cansın</h2><Link className="text-link" href="/">Ana sayfaya dön <ArrowIcon /></Link></div>
