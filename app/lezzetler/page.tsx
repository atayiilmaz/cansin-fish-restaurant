...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/lezzetler", languages: { "tr-TR": "/lezzetler", "en-US": "/en/menu" } },
...
export default function FlavoursPage() {
  return (
    <main>
      <section className="page-hero page-hero-short parallax-frame"><Image data-parallax src={siteImages.platter} alt="Cansın Restaurant deniz ürünleri sofrası" fill priority sizes="100vw" /><div className="page-hero-overlay" /><div className="page-hero-copy"><h1 data-hero-reveal>Lezzetler</h1><p data-hero-reveal>Balığın tazesi, ateşin kararı ve İstanbul’un bildiği tatlar.</p></div></section>
      <section className="dish-list" data-reveal>
        <div className="dish-intro" data-reveal-item><h2>Denizin verdiğini<br /><span className="accent">özenle hazırlıyoruz.</span></h2><p>Ürün seçimi mevsime ve günlük tedariğe göre değişebilir. Günün seçeneklerini ekibimize sorabilirsiniz.</p></div>
