  ...
  return (
    <main>
      ...
      <section className="editorial-section" data-reveal>
        <div className="editorial-lead" data-reveal-item><p className="eyebrow dark">Galata Köprüsü’nde</p><h2>Şehrin sesini<br /><span className="accent">sofraya taşıyoruz.</span></h2></div>
