...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/hakkimizda", languages: { "tr-TR": "/hakkimizda", "en-US": "/en/about" } },
  ...
  return (
    <main>
      <section className="page-hero parallax-frame">
        <Image data-parallax src={siteImages.hero} alt="Cansın Restaurant salonu" fill priority sizes="100vw" />
        <div className="page-hero-overlay" />
        <div className="page-hero-copy"><h1 data-hero-reveal>Hakkımızda</h1><p data-hero-reveal>İstanbul’un akışını denizin üzerinden izleyen bir sofra.</p></div>
      </section>
      <section className="editorial-section" data-reveal>
        <div className="editorial-lead" data-reveal-item><h2>Şehrin sesini<br /><span className="accent">sofraya taşıyoruz.</span></h2></div>
      ...
      <section className="split-feature" data-reveal>
        <div className="split-image parallax-frame" data-reveal-item><Image data-parallax src={siteImages.view} alt="Galata Köprüsü altında Cansın Restaurant" fill sizes="(max-width: 820px) 100vw, 58vw" /></div>
        <div className="split-copy" data-reveal-item><h2>Denize yakın,<br />şehre ait.</h2><p>Eminönü’nün hareketi birkaç basamak yukarıda; sofranızın hemen yanında ise suyun sakinliği var.</p><Link className="button button-light" href="/iletisim">Bizi bulun <ArrowIcon /></Link></div>
      </section>
    </main>
  );
}
